        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm mb-4">
              Connecting skilled artisans with clients across South Africa for quality home improvement services.
            </p>
            <div className="flex space-x-4">
              {/* Social Media Icons */}
              <a
                href="https://facebook.com/taska"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary-400 transition-colors"
                aria-label="Facebook"
              >
                <svg className="w-5 h-5" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                </svg>
              </a>
              <a
                href="https://twitter.com/taskaplatform"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary-400 transition-colors"
                aria-label="Twitter"
              ...
              <a
                href="https://linkedin.com/company/taska"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary-400 transition-colors"
                aria-label="LinkedIn"
              ...
              <a
                href="https://instagram.com/taska"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-primary-400 transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/insurance" className="text-sm hover:text-white transition-colors">
                  Insurance
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="text-sm text-gray-400">
              &copy; {currentYear} Taska. All rights reserved.
            </p>
          </div>
        </div>
      </div>
