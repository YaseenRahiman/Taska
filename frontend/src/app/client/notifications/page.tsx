...
interface Notification {
  id: string
  type: 'BID_RECEIVED' | 'BID_ACCEPTED' | 'JOB_COMPLETED' | 'NEW_MESSAGE' | 'PAYMENT_SENT' | 'REVIEW_RECEIVED' | 'ARTISAN_UPDATE' | 'SYSTEM'
  title: string
  message: string
  read: boolean
  createdAt: string
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Stay updated with your jobs and artisan activity
                {unreadCount > 0 && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-blue-900">
                  ...
                  <p className="text-blue-800">
                    ...
                    <a href="/client/settings?tab=notifications" className="underline font-medium">
                      Settings
                    </a>
                  </p>
                </div>
