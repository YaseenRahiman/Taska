...
export const metadata: Metadata = {
  ...
  description: 'Create your Taska account to post jobs and connect with skilled artisans.',
};
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Join Taska and connect with skilled artisans
            </p>
          </div>
          ...
          <div className="card mt-8">
            ...
            <div className="mt-6 text-center text-sm">
              ...
              <Link href="/auth/login" className="font-medium text-primary-600 hover:text-primary-500" data-testid="login-link">
                Sign in
              </Link>
            </div>
          </div>
