...
import { Settings, List, BarChart3, ChevronDown } from 'lucide-react';
...
type TabId = 'settings' | 'holds' | 'analytics';
...
const tabs: Tab[] = [
  {
    ...
    description: 'Configure escrow rules and parameters',
  },
  {
    id: 'holds',
    label: 'Active Holds',
    icon: List,
    component: ActiveHoldsTable,
    description: 'View and manage all escrow holds',
  },
  {
    id: 'analytics',
    label: 'Analytics',
...
export default function EscrowConfigPage() {
  ...
  const ActiveComponent =
    tabs.find((t) => t.id === activeTab)?.component || SettingsForm;
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-600">
            Manage payment holds, configure escrow settings, and monitor financial transactions
          </p>
        </div>
        ...
        <div className="hidden md:block text-xs text-gray-500 text-center">
          <p>
            Keyboard shortcuts: Alt+1-3 to switch tabs, Arrow keys when focused
            on tabs
          </p>
        </div>
      </div>
